...
1. Spawn the `claude-code-guide` agent using the Task tool:
...
1. Summarize the agent's response back to the user in a clear, concise format
1. If the agent was previously used in this conversation, resume it using the `resume` parameter with its agent ID to preserve context
